document.addEventListener("DOMContentLoaded", () => {
  ...
  loaderTL
    ...
    .to(".preloader", { opacity:0, duration:0.6, delay:0.3, ease:"power4.out", onComplete: () => {
  ...
  mm.add({
    "(min-width:600px)": () => {
      ...
      mainTimeline
        .from(".logo", { y:-80, opacity:0, scale:0.5, duration:1.5, ease:"bounce.out" }, "start")
  ...
  mm.add({
    "(min-width:600px)": () => {
      gsap.from(".about-img-wrapper", {
        ...
        scrollTrigger:{ trigger:".about-img-wrapper", start:"top 85%", end:"bottom 15%", toggleActions:"play none none reverse", scrub:false, once:true }
      });

      gsap.from(".part", {
        x:80, opacity:0, duration:1,
        scrollTrigger:{ trigger:".part", start:"top 85%", end:"bottom 15%", toggleActions:"play none none reverse", scrub:false, once:true }
      });

      gsap.from(".about-points p", {
        y:30, opacity:0, duration:0.8, stagger:0.2,
        scrollTrigger:{ trigger:".about-points", start:"top 85%", end:"bottom 15%", toggleActions:"play none none reverse", scrub:false, once:true }
      });
    },
    "(max-width:599px)": () => {
      gsap.from(".about-img-wrapper", {
        y:40, opacity:0, duration:0.8,
        scrollTrigger:{ trigger:".about-img-wrapper", start:"top 90%", toggleActions:"play none none reverse", scrub:false, once:true }
      });

      gsap.from(".part", {
        y:40, opacity:0, duration:0.8,
        scrollTrigger:{ trigger:".part", start:"top 90%", toggleActions:"play none none reverse", scrub:false, once:true }
      });

      gsap.from(".about-points p", {
        y:25, opacity:0, duration:0.6, stagger:0.15,
        scrollTrigger:{ trigger:".about-points", start:"top 90%", toggleActions:"play none none reverse", scrub:false, once:true }
      });
    }
  });
  ...
  gsap.utils.toArray(".road-map-card").forEach((card,i) => {
    gsap.from(card, {
      y:60, opacity:0, duration:0.8, delay:i*.15,
