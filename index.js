document.addEventListener("DOMContentLoaded", () => {
  ...
  function runInit() {
    // Make sure content is visible after preloader
    document.body.style.overflow = "auto";
    document.body.style.height = "auto";
    
    if (preloader) {
      // Ensure preloader is hidden properly
      gsap.to(preloader, {
        opacity: 0,
        display: "none",
        duration: 0.5,
